...
<body>
    ...
    <pre>
        ...
        (세션에 로그인 정보를 기록해둠
            -> 브라우저 종료되거나, 로그아웃이 되기 전 까지 계속 로그인 상태가 유지)
        
        4. application : 하나의 웹 어프리케이션 당 1개만 생성되는 객체.
            -> 서버 시작 시 생성되며 종료시 까지 유지, 
        ...
        *****************************
        -> setAttribute("key",value)로 내장 객체가 값을 세팅할 때
            ...
            \${key} 로 작성 하는 경우 범위가 작은 내장 객체가 높은 우선 순위를 갖게 된다.
