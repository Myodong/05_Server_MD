 ...
 <body>
    ...
    <ol>
        ...
        <li>webapp/WEB-INF/lib 에 추가하기</li>
    </ol>
    ...
    <%-- 단독 if문인 경우의 단점 : else 상황에 대한 if문을 별도 작성 필요
    ...
    <pre>
        ...
        6) varStatus : 현재 반복 상태와 관련된 정보를 제공하는 변수 선언
                        varStatus="변수명"
                        -> c:forEach 구문 내에서 "변수명"을 통해 원하는 값을 얻어 올 수 있다.

                        * varStatus에서 제공되는 값
                        - current : 현재 반복 횟수(현재 var 값) 또는 현재 반복 접근 중인 객체(컬렉션/배열 요소)

                        - index   : 현재 몇 번째 인덱스값 반환 (0부터 시작)
